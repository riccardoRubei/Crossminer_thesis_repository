...
\begin{itemize}
	...
	\item Perform a comprehensive evaluation of the tools using a dataset collected from GitHub. %CrossSim with three state-of-the-art tools for software similarity measurement.
\end{itemize}
